...
namespace Lead.CPrim.PrimKeyenceLJ
{
	...
	static class Utility
    {
        ...
        public static byte[] GetIpAddressFromTextBox(TextBox textBoxFirstSegment, TextBox textBoxSecondSegment, TextBox textBoxThirdSegment, TextBox textBoxFourthSegment)
        {
            return new byte[]
            {
                Convert.ToByte(textBoxFirstSegment.Text),
                Convert.ToByte(textBoxSecondSegment.Text),
                Convert.ToByte(textBoxThirdSegment.Text),
                Convert.ToByte(textBoxFourthSegment.Text)
            };
        }
        #endregion
    }
